                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select name="type" class="form-control" required x-on:change="userType = $event.target.value">
                                    <option value="{{ $model::TYPE_EMPLOYER }}" {{ $user->type === $model::TYPE_EMPLOYER ? 'selected' : '' }}>@lang('Employer')</option>
                                    <option value="{{ $model::TYPE_FREELANCER }}" {{ $user->type === $model::TYPE_FREELANCER ? 'selected' : '' }}>@lang('Freelancer')</option>
