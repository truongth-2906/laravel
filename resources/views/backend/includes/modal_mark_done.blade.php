<div class="modal fade" id="modal-mark-done-job-application" tabindex="-1" role="dialog"
                ...
                <div class="col-md-10 content-confirm">
                    <div>
                        <h4 class="modal-title modal-text-logout title-center-logout"
                            id="myModalLabel">@lang('Do You Want To Complete The Job?')</h4>
                    ...
                    <form>
                        <div class="pt-2 text-color">
                            @lang('By marking this job as done or completed, you will close this project and a notifications will be sent to all the freelancers that the status of this job changed.')
                        </div>
                    </form>
                    <div class="modal-footer no-gutters border-0 pt-5 modal-footer-custom">
                        ...
                        <div class="area-btn-footer-modal">
                            ...
                            <div class="d-flex align-items-center group-btn-modal group-btn-submit cursor-pointer btn-agree-mark-done">
                                <div class="font-weight-600 color-2200A5 text-uppercase mr-2">@lang('MARK DONE')</div>
