...
@section('title', __('Manage Employers'))

@section('content')
    <div class="container-fluid container-freelancer pl-0 pr-0 mb-5 pc-device admin-employers">
        <div class="w-100 header-freelancer">
            <div class="d-flex flex-column align-items-start">
                <div class="d-flex justify-content-start align-items-center">
                    <div class="color-000000 font-18 font-weight-bold mr-2">@lang('Manage Employers')</div>
                    <div
                        class="color-2200A5 font-12 total-freelancer d-flex justify-content-center align-items-center total-employer">
                        {{ $employers->total() }} @lang(' Employers')
                    </div>
                </div>
                <div class="color-000000 font-14">@lang('Keep track of employer and their activity.')</div>
            </div>
            <div class="d-flex justify-content-center align-items-center child-second">
                <a href="{{ route('admin.employer.create') }}"
                   class="btn btn-general-action d-flex justify-content-center align-items-center hover-button">
                    ...
                    <div class="color-2200A5 font-14 font-weight-bold">@lang('ADD EMPLOYER')</div>
                </a>
            </div>
        </div>
        ...
        <div class="w-100 area-search">
            ...
            <div class="d-flex justify-content-end align-items-center w-60 child-second">
                <div class="d-flex justify-content-end align-items-center w-100 child-second" id="search">
                    <input type="text" class="ipt-search-employer ipt-search w-60 mr-3 font-16 color-000000"
                           placeholder="{{ __('Search') }}">
                    <button type="button" data-toggle="modal" data-target="#filter-modal"
                            class="btn btn-filter btn-general-action d-flex justify-content-start align-items-center mr-3 position-relative hover-button">
                        <img src="{{ asset('/img/filter_icon.svg') }}" alt="" class="mr-2">
                        <div class="color-2200A5 font-14 font-weight-bold">@lang('FILTER')</div>
                    </button>
                </div>
                <button type="submit" form="form-export-employers"
                        class="btn btn-general-action d-flex justify-content-center align-items-center hover-button">
        ...
        <div class="w-100 list-wrapper">
            @include('backend.employer.table')
        </div>
    </div>

    <div class="container-fluid container-freelancer mobile-device admin-employers">
        ...
        <div class="d-flex justify-content-start align-items-center mt-3 mb-3">
            ...
            <a class="btn btn-general-action d-flex justify-content-center align-items-center hover-button"
               href="{{ route('admin.employer.create') }}">
                <img src="{{ asset('/img/add_icon.svg') }}" alt="" class="mr-2">
                <div class="color-2200A5 font-14 font-weight-bold">@lang('ADD EMPLOYER')</div>
            </a>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mt-1 mb-3">
            <div class="d-flex justify-content-between align-items-center w-100" id="search">
                <input type="text" class="ipt-search ipt-search-employer w-60 mr-3 font-16 color-000000 w-90"
                ...
                <button type="button" data-toggle="modal" data-target="#filter-modal"
                    ...
                    <img src="{{ asset('/img/filter_gray_icon.svg') }}" alt="">
                </button>
            </div>
        </div>
    ...
    @include('backend.employer.filter-modal')
    @include('backend.includes.modal_confirm_delete', ['type' => TYPE_EMPLOYER])
@endsection
