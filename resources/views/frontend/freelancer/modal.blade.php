<div class="modal fade filter-modal-fe color-initial" id="filter-modal-job" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
     data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0 pb-0">
                <form action="" method="get" id="filter-modal-job-form" class="flex-center flex-column justify-content-start align-items-start">
                    <div class="flex-center flex-column align-items-start w-100 mb-2">
                        <p class="mb-0 font-14 color-000000">@lang('Filter by search')</p>
                        <input type="text" name="text" class="ipt-search-freelancer font-16 w-100 ipt-search-filter"
            ...
            <div class="modal-footer p-3 flex-center justify-content-end">
                <button type="button" class="btn btn-cancel color-2200A5 mr-2"
                        data-dismiss="modal">@lang('Cancel')</button>
                <button type="submit" class="btn btn-search btn-search-filter color-2200A5" form="filter-modal-job-form">
                    @lang('Search')
