<div>
    <div class="w-100 table-wrapper">
        <table id="jobs-table">
            ...
            <tbody>
                <tr>
                    <td class="align-middle column-md disabled">
                    ...
                    <td class="align-middle disabled font-14 column-md disabled" title="{{ $job->name ?? '' }}">
                        {{ $job->name ?? '' }}</td>
                    <td class="align-middle column-lg disabled">
                        <div class="d-flex justify-content-start align-items-center flex-wrap">
                            ...
                            @if (!is_null($job->experience))
                                <div class="tag tag__pill mr-2 my-1 disabled" title="{{ $job->experience->name ?? '' }}">
                                    {{ $job->experience->name ?? '' }}
                                </div>
                            @endif
                    ...
                    <td class="align-middle column-sm disabled">
                        @if ($job->isOpen())
            ...
            <div class="flex-center flex-column w-100">
                ...
                <div class=" w-100 tab-content layout-switch-tab tab-overview">
                    <div class="d-flex flex-column part">
                        ...
                        <p class="color-475467 text-break">@lang('The employer is looking for a freelance who have the skills in the categories selected.')</p>
                        <div class="d-flex flex-wrap">
                            ...
                            @endforeach
                            @if (!is_null($job->experience))
                                <div class="tag tag__rectangle tag__experience mr-2 my-1">{{ $job->experience->name ?? '' }}
                                </div>
                            @endif
                            @if (!is_null($job->country))
