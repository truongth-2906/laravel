...
@section('content')
    <div class="billing-and-payment">
        ...
        <div class="billing-column pt-4">
            {{-- <div class="container-fluid container-freelancer draw-height billing-width-method billing-border mb-sm-2">
                <div class="header-freelancer flex-wrap">
                    <div class="d-flex flex-column align-items-start">
                        <div class="d-flex justify-content-start align-items-center">
                ...
                <div class="d-flex justify-content-end align-items-center child-second mt-3 mb-3">
                    <button
                        ...
                        <div class="color-2200A5 font-14 font-weight-bold">@lang('WITHDRAW NOW')</div>
            ...
            <div class="container-fluid container-freelancer draw-height billing-width-method billing-border mb-sm-2">
                ...
                <div class="d-flex justify-content-end align-items-center child-second mt-3 mb-3">
                    <a href="{{ route('frontend.freelancer.payments.escrow_account.create') }}"
                        class="btn btn-general-action d-flex justify-content-center align-items-center import-freelancer hover-button">
                        @if (!is_null($escrowEmail))
        ...
        <div class="w-100 area-download flex-wrap pt-4">
            <div class="d-flex justify-content-center align-items-center filter-status mb-sm-2 mr-5">
                <div class="d-flex flex-column align-items-start">
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="color-000000 font-18 font-weight-bold mr-2">@lang('Transaction history')</div>
                    </div>
                    <div class="color-000000 font-14">@lang('Overview of all your past and current transactions.')</div>
                </div>
            </div>
        ...
        <div class="container-fluid container-freelancer front-end pl-0 pr-0 mt-4">
            <div class="w-100 list-wrapper">
                @include('frontend.freelancer.payment.table')
            </div>
        </div>
    </div>
@endsection
