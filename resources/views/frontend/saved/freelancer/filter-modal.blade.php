<div class="modal fade filter-modal" id="employer-filter-freelancer-modal" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body flex-center flex-column justify-content-start align-items-start pt-0 pb-0">
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <input type="text" name="keyword" class="ipt-employer-find-freelancer font-16 w-100" form="search-form"
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div
                        ...
                        <select name="category_id[]" class="js-states form-control" id="form-select-categories" form="search-form"
                            multiple="multiple">
                            @foreach (getListCategory() as $category)
                                <option class="{{ $category->class }}" value="{{ $category->id }}">{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div
                        ...
                        <select class="js-states form-control" name="experience_id" id="form-select-rpa-experience" form="search-form">
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div
                        ...
                        <select name="country_id" id="form-select-country" class="js-states form-control" form="search-form">
            ...
            <div class="modal-footer p-3 flex-center justify-content-end">
                <button type="reset" class="btn btn-cancel color-2200A5 mr-2 mt-0"
                    data-dismiss="modal" form="search-form">@lang('Cancel')</button>
                <button type="submit" class="btn btn-search color-2200A5" form="search-form">
                    @lang('Search')
