<div class="modal fade filter-modal-fe color-initial filter-modal" id="filter-job-modal" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body flex-center flex-column justify-content-start align-items-start pt-0 pb-0">
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <input type="text" name="keyword" class="ipt-search-freelancer font-16 w-100 ipt-search-filter"
                        form="search-form" placeholder="{{ __('Type to search') }}">
                </div>

                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    <p class="mb-0 font-14 color-000000">@lang('Filter by business sector')</p>
                    <div
                        class="form-content text-color font-size-16 w-100 form-select2-container form-select-sector-container">
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div
                        ...
                        <select class="js-states form-control" id="form-select-categories" multiple="multiple"
                            name="category_id[]" form="search-form">
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div
                        class="form-content text-color font-size-16 w-100 form-select2-container form-select-rpa-experience-container">
                ...
                <div class="flex-center flex-column align-items-start w-100 mb-2">
                    ...
                    <div class="form-select form-select-lg w-100 form-select2-container form-select-country-container">
            ...
            <div class="modal-footer p-3 flex-center justify-content-end">
                <button type="reset" class="btn btn-cancel color-2200A5 mr-2 mt-0"
                    data-dismiss="modal">@lang('Cancel')</button>
                <button type="submit" class="btn btn-search btn-search-filter color-2200A5" form="search-form">
                    @lang('Search')
