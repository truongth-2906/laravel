<div class="w-100 table-wrapper">
    <table id="jobs-table">
        <thead>
            <tr>
                <th class="column-md font-12 font-weight-500">@lang('Listing as')</th>
                <th class="column-md font-12 font-weight-500">@lang('Job Title')</th>
                <th class="column-lg font-12 font-weight-500">@lang('Job Requirements')</th>
                <th class="column-sm">
                    <div
        ...
        <tbody>
            @forelse ($jobs as $job)
                <tr>
                    <td class="column-md">
                        <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="d-flex flex-column align-items-start flex-grow-1 name-and-mail">
                                ...
                                <a class="font-14 color-000000 long-text" href="{{ !is_null($job->user) ? route('frontend.employer.profile', $job->user->id) : '#' }}"
                    ...
                    <td class="column-md font-14 color-000000" title="{{ $job->name ?? '' }}">{{ $job->name ?? '' }}
                    </td>
                    <td class="column-lg">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="flex-center cursor-pointer mr-1 btn-action hover-button">
                                <img class="icon-heart-job" data-job-id="{{ $job->id }}"
                                     src="{{ asset('/img/icon-red-heart.svg') }}"
                                     alt="">
                            </div>
                            @if ($job->isOpen())
