...
@section('content')
    <div class="wrapper">
        <form autocomplete="off"
            action="{{ route('frontend.employer.payments.escrow_account.store', ['job_id' => request()->query('job_id')]) }}"
            method="post" id="add-escrow-account-form">
            @csrf
            <div class="form-header d-flex justify-content-between align-items-center">
                <div class="text-header primary-color font-weight-500 text-uppercase">@lang('Add your Escrow account')</div>
            </div>
            ...
            <div
                ...
                <div class="form-group-button-title">
                    ...
                    <div class="font-weight-400 font-size-14 description-color">@lang('Update your Escrow email here.')
                    </div>
                </div>
                <div class="form-group-button d-flex">
                    <a class="button-base btn-general-action hover-button text-decoration-none"
                        href="{{ route(EMPLOYER_PAYMENT_INDEX) }}">@lang('Cancel')</a>
    ...
    <input type="hidden" class="warning_message">
@endsection
