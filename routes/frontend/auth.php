...
use App\Domains\Auth\Http\Controllers\Frontend\Auth\VerifiedController;
use App\Domains\Auth\Http\Controllers\Frontend\Auth\WebhookController;
...
Route::group(['as' => 'auth.'], function () {
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(['middleware' => 'password.expires'], function () {
            ...
            Route::group([
                ...
                Route::get('step1', [VerificationController::class, 'step1'])->name('step1');
                Route::get('step2', [VerificationController::class, 'step2'])->name('step2');
                Route::post('step3', [VerificationController::class, 'step3'])->name('step3');
            ...
            Route::group(['middleware' => config('base.access.middleware.verified')], function () {
                // Passwords
                ...
                Route::group([
                    ...
                    Route::post('job', [SavedController::class, 'saveJob'])->name('job');
                });
            });
            ...
            Route::group([
                ...
                Route::get('/verify', [VerifiedController::class, 'index'])->name('index');
            });
        });
    });
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('password/resend', [ForgotPasswordController::class, 'showResendRequestForm'])->name('password.resend');
        Route::get('password/reset/{token}', [ResetPasswordController::class, 'showResetForm'])->name('password.reset')->middleware(['signed', 'throttle:6,1']);
        ...
        Route::post('passbase-webhooks', [WebhookController::class, 'receive_passbase_webhook'])->name('webhook');
    });
});
