...
abstract class BaseService
{
     ...
     * @return string
     */
    protected function handleOrderBy($order)
    {
        $order = is_null($order) ? TYPE_SORT_DESC : strtoupper($order);
        $order = in_array($order, [TYPE_SORT_ASC, TYPE_SORT_DESC]) ? $order : TYPE_SORT_DESC;
