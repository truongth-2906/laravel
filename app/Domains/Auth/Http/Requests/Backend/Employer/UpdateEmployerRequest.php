...
class UpdateEmployerRequest extends FormRequest
{
    ...
    {
        $rules = [
            'firstname' => ['bail', 'bail', 'required', 'max:100'],
            'lastname' => ['bail', 'required', 'max:100'],
            'type' => ['bail', Rule::in([User::TYPE_ADMIN, User::TYPE_FREELANCER, User::TYPE_EMPLOYER])],
            'email' => ['bail', 'required', 'max:255', 'email', 'unique:users,email,' . $this->employer_id . ',id,deleted_at,NULL'],
